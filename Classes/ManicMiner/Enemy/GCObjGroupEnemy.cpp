...
static CGCFactoryCreationParams s_cCreationParams_CGCObj_Type1("CGCObjEnemy_EDuck", "TexturePacker/Sprites/Coin/Coin.plist", "coin", b2_dynamicBody, true);
static CGCFactoryCreationParams s_cCreationParams_CGCObj_Type2("CGCObjEnemy_EPenguin", "TexturePacker/Sprites/KoopaTrooper/KoopaTrooper.plist", "koopa", b2_dynamicBody, true);
...
void CGCObjGroupEnemy::CreateEnemys()
{
		...
		// koopas
		 ...
		 CGCObjEnemy* pEnemy = new CGCObjEnemy(CGCObjEnemy::EMovementAxis_LeftRight, cocos2d::Vec2(50.0f,100.0f), 500.0f, 300.0f, false, 2.0f, true, EnemyTypes::EEnemyId::EDuck, rFactoryCreationParams_Type1);
		 pEnemy->SetName("Derek2");
		 
		 CGCObjEnemy* pEnemy2 = new CGCObjEnemy(CGCObjEnemy::EMovementAxis_LeftRight, cocos2d::Vec2(100.0f, 250.0f), 550.0f, 200.0f, true, 1.0f, true, EnemyTypes::EEnemyId::EDuck, rFactoryCreationParams_Type1);
		 pEnemy2->SetName("Derek3");
		 
		 CGCObjEnemy* pEnemy3 = new CGCObjEnemy(CGCObjEnemy::EMovementAxis_LeftRight, cocos2d::Vec2(150.0f, 400.0f), 250.0f, 200.0f, true, 1.0f, true, EnemyTypes::EEnemyId::EDuck, rFactoryCreationParams_Type1);
