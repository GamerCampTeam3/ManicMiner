...
#ifndef _CMLATTACKOFTHEMUTANT_H_
#define _CMLATTACKOFTHEMUTANT_H_
...
class CMLAttackOfTheMutant : public CManicLayer
{
public:
	// Constructor -------------------------------------------------------------------------------------------------------- //
	CMLAttackOfTheMutant();
	// Destructor --------------------------------------------------------------------------------------------------------- //
	virtual ~CMLAttackOfTheMutant();
...
#endif //#ifndef _CMLATTACKOFTHEMUTANT_H_