...
#ifndef _CMLTHESIXTEENTHLAB_H_
#define _CMLTHESIXTEENTHLAB_H_
...
class CMLTheSixteenthCavern : public CManicLayer
{
public:
	// Constructor -------------------------------------------------------------------------------------------------------- //
	CMLTheSixteenthCavern();
	// Destructor --------------------------------------------------------------------------------------------------------- //
	virtual ~CMLTheSixteenthCavern();
...
#endif //#ifndef _CMLTHESIXTEENTHLAB_H_