...
void CMLAttackOfTheMutant::VOnCreate( void )
{
	...
	m_sLevelCreationParameters.szLevelPath = "OgmoEditor/AttackOfTheMutant.oel";
	m_sLevelCreationParameters.szLevelName = "Attack Of The Mutant";
...
void CMLAttackOfTheMutant::InitParams()
{
