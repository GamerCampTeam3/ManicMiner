...
public:
	...
	// End of level functions, used to call next level and also to drain the score
	void	EndLevel() ;
	void	DrainToScore();
	bool	GetCanDrainToScore() const { return m_bDrainToScore; }
private:
	int		m_iCurrentScore;
	int		m_iHighScore;
	int		m_iCurrentLives;
	...
	static const int m_kiScorePerTimeLeft	= 11;		// How much score each tick will give
