...
// 
// 
// void CGCObjPlayer::KeyboardInput()
// {
// 
...
// 	if (m_bCanJump)
// 	{
// 		if ((pKeyManager->ActionIsPressed(CGCGameLayerPlatformer::EPA_Jump)) || (pKeyManager->ActionIsPressed(CGCGameLayerPlatformer::EPA_Up)))
// 		{
// 
