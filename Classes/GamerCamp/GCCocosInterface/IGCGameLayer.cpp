...
void IGCGameLayer::VOnResourceRelease( void)
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
	// HENRIQUE NOTED OUT:
	// This is being called after a second level is created, loaded, initiated
	// It will delete all the GB2ShapeCache, which will delete not only this level's cache
	// But it will also delete the cache of the level we just created
	// This leads to a crash when, for example, VOnReset() is called
	// That will end up calling AddFixturesToBody() which needs the cache otherwise it has
	// No idea what shapes the assets are
	
